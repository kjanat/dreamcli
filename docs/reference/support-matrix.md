...
| ---------------------------------------------------------------- | --------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| Schema-first parse -> resolve -> execute flow                    | Supported | [CLI Semantics](/guide/semantics), [`runCommand()`](/reference/testkit), [`src/core/testkit/index.ts`](https://github.com/kjanat/dreamcli/blob/master/src/core/testkit/index.ts), [`src/core/execution/index.ts`](https://github.com/kjanat/dreamcli/blob/master/src/core/execution/index.ts)         | The shared executor now owns the canonical command execution flow; testkit is the in-process wrapper. |
