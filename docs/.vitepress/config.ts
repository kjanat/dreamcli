			...
			'/reference/': [
				{
					...
					items: [
						...
						{ text: '@kjanat/dreamcli/completion', link: '/reference/completion' },
						{ text: '@kjanat/dreamcli/json-schema', link: '/reference/json-schema' },
						{ text: '@kjanat/dreamcli/config', link: '/reference/config' },
						{ text: '@kjanat/dreamcli/prompt', link: '/reference/prompt' },
						{ text: '@kjanat/dreamcli/schema', link: '/reference/schema' },
						{ text: '@kjanat/dreamcli/version', link: '/reference/version' },
					],
				},
			],
		},
