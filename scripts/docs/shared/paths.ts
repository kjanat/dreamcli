...
export const referenceChangelogPagePath = join(docsRoot, 'reference', 'changelog.md');
export const referenceDocsHealthPagePath = join(docsRoot, 'reference', 'docs-health.md');
