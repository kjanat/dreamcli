...
export const EXAMPLE_HOVER_PROTOTYPE_ROUTE_PATH = '/examples/hover-prototype';
...
export function renderExampleHoverPrototypePage(example: ExampleEntry): string {
	return [
		GENERATED_HEADER,
		'',
		...
		'',
		`- Prototype route: \`${EXAMPLE_HOVER_PROTOTYPE_ROUTE_PATH}\``,
		`- Backing example: [\`${example.sourcePath}\`](${example.sourceUrl})`,
		'- Scope: examples only',
