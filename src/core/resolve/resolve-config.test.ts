...
describe('resolve', () => {
	...
	// --- config satisfies required flags

	describe('config satisfies required flags', () => {
	...
	// --- full precedence chain with config

	describe('full precedence chain with config', () => {
	...
	// --- no config options (backward compatibility)

	describe('no config options (backward compatibility)', () => {
	...
	// --- config error aggregation

	describe('config error aggregation', () => {
