...
describe('resolve', () => {
	...
	// --- env satisfies required flags

	describe('env satisfies required flags', () => {
	...
	// --- no env options (backward compatibility)

	describe('no env options (backward compatibility)', () => {
	...
	// --- env error aggregation

	describe('env error aggregation', () => {
