...
describe('runCommand', () => {
	// --- mergedSchema injection

	describe('mergedSchema injection', () => {
...
describe('CLIBuilder.execute', () => {
	// --- nested dispatch with env injection

	describe('nested dispatch with env injection', () => {
	...
	// --- nested dispatch with config injection

	describe('nested dispatch with config injection', () => {
	...
	// --- nested dispatch with middleware

	describe('nested dispatch with middleware', () => {
	...
	// --- nested dispatch with verbosity

	describe('nested dispatch with verbosity', () => {
	...
	// --- nested dispatch with JSON mode

	describe('nested dispatch with JSON mode', () => {
	...
	// --- nested dispatch with TTY

	describe('nested dispatch with TTY', () => {
	...
	// --- nested dispatch error cases

	describe('nested dispatch error cases', () => {
	...
	// --- nested help variations

	describe('nested help variations', () => {
	...
	// --- 3-level nesting with testkit options

	describe('3-level nesting with testkit options', () => {
		function threeLevel() {
			const up = command('up')
