...
```ts twoslash
import { greet } from './apps/docs/.vitepress/twoslash/testing-fixtures.ts';
// ---cut---
...
```ts twoslash
import { regionCmd } from './apps/docs/.vitepress/twoslash/testing-fixtures.ts';
// ---cut---
import { runCommand } from '@kjanat/dreamcli/testkit';
...
```ts twoslash
import { promptCmd } from './apps/docs/.vitepress/twoslash/testing-fixtures.ts';
// ---cut---
import { runCommand } from '@kjanat/dreamcli/testkit';
...
```ts twoslash
import { jsonListCmd } from './apps/docs/.vitepress/twoslash/testing-fixtures.ts';
// ---cut---
import { runCommand } from '@kjanat/dreamcli/testkit';
